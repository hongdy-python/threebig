"""
Django settings for threebig project.
...
SECRET_KEY = '97w()7l80(zm-#mr2myxa7fh(*$7a5gl!9g1+bd(kwb0n_hm*j'
...
WSGI_APPLICATION = 'threebig.wsgi.application'
